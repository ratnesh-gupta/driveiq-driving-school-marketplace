...
export default function ProfilePage() {
  ...
  const { data: school, isLoading } = useGetSchool(DEMO_SCHOOL_ID, { query: { queryKey: getGetSchoolQueryKey(DEMO_SCHOOL_ID) } });
  ...
  const handleSave = () => {
    updateSchool.mutate(
      { id: DEMO_SCHOOL_ID, data: form },
      {
        onSuccess: () => {
          queryClient.invalidateQueries({ queryKey: getGetSchoolQueryKey(DEMO_SCHOOL_ID) });
