...
import { useListFeaturedSchools, useListLocalities, useGetStatsOverview } from "@workspace/api-client-react";
          ...
          {loadingSchools ? (
            ...
            >
              {(featuredSchools || []).map((school) => (
                <motion.div key={school.id} variants={fadeIn} whileHover={{ y: -4, transition: { duration: 0.2 } }}>
