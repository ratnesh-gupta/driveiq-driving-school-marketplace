...
export default function LeadsPage() {
  ...
  const params = { schoolId: DEMO_SCHOOL_ID, ...(statusFilter ? { status: statusFilter } : {}) };
  ...
  const handleStatusChange = (id: number, status: string) => {
    updateInquiry.mutate(
      ...
      {
        onSuccess: () => {
          queryClient.invalidateQueries({ queryKey: getListInquiriesQueryKey({ schoolId: DEMO_SCHOOL_ID }) });
