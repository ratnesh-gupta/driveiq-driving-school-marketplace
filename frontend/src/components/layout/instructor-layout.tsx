  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      <div className="h-16 flex items-center px-6 border-b">
        <Link href="/" className="font-bold text-xl text-primary tracking-tight">{t("instructorNav.brand")}</Link>
      </div>
    ...
    <div className="min-h-[100dvh] flex flex-col md:flex-row bg-muted/20">
      ...
      <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
        <header className="h-16 border-b bg-card flex items-center justify-between px-4 md:px-8">
          ...
          <div className="font-semibold text-lg ml-2 md:ml-0">{t("instructorNav.title")}</div>
