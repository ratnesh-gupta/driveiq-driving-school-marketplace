...
export default function DataRequestPage() {
  ...
  const [requestType, setRequestType] = useState<"access" | "correction" | "deletion" | "other">("access");
    ...
    <PublicLayout>
      <div className="container mx-auto px-4 py-12 max-w-lg">
        ...
        <p className="text-sm text-muted-foreground mb-6">
          Request access, correction, or deletion of your personal data. We aim to respond within a
          reasonable period. See our <Link href="/privacy" className="underline text-primary">Privacy Policy</Link>.
        </p>
