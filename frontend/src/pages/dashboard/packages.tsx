...
export default function PackagesPage() {
  ...
  const handleSave = () => {
    const data = { ...form, price: parseFloat(form.price), sessions: parseInt(form.sessions), schoolId: schoolId! };
    const onSuccess = () => {
      queryClient.invalidateQueries({ queryKey: getListPackagesQueryKey({ schoolId: schoolId! }) });
